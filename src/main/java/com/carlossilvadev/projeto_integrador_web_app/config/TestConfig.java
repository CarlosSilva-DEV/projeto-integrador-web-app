...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		User u1 = new User("Maria", "mari1209", "maria@gmail.com", "999999999", "123456");
		User u2 = new User("Alex", "alex_098", "alex@hotmail.com", "912345678", "123456");
		u1.setSenha(passwordEncoder.encode(u1.getSenha()));
		u2.setSenha(passwordEncoder.encode(u2.getSenha()));
		
		Order o1 = new Order(OrderStatus.AGUARDANDO_PAGAMENTO, u1);
		Order o2 = new Order(OrderStatus.PAGO, u2);
		Order o3 = new Order(OrderStatus.ENVIADO, u1);
