...
@Configuration
@Profile({"test", "dev", "prod"}) // define como uma classe de configuração, especifica pros perfis "test" e "dev"
public class TestDevProdConfig implements CommandLineRunner{
	@Autowired
